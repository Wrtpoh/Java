...
public class Main15 {
    ...
    public static void main(String[] args) {
        ...
        int x16 = sc.nextInt();
        System.out.println("Поиск по значению" + obj.findFirst(arr16, x16)); //{1, 2, 3, 4, 2, 2, 5}
        ...
        System.out.println("Максимум по модулю: " + obj.maxAbs(arr17));
        ...
        int pos = sc.nextInt();
        System.out.println("Результат: " + Arrays.toString(obj.add(arr18, ins, pos)));
        ...
        System.out.println("Перевёрнутый массив: " + Arrays.toString(obj.reverseBack(arr19)));
        ...
        System.out.print("Введите число для поиска: ");
        int x20 = sc.nextInt();
        System.out.println("Все вхождения числа: " + Arrays.toString(obj.findAll(arr20, x20)));
    }
}
